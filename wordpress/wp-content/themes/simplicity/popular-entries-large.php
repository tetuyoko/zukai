...
<div class="popular-entry">
  ...
  <?php if ( has_post_thumbnail() ): // サムネイルを持っているときの処理 ?>
    <a href="<?php the_permalink(); ?>" class="popular-entry-link"><?php the_post_thumbnail( 'thumb320', array('style' => 'width:100%;height:auto;') ); ?></a>
  <?php else: // サムネイルを持っていないときの処理 ?>
    <a href="<?php the_permalink(); ?>" class="popular-entry-image"><img src="<?php echo get_template_directory_uri(); ?>/images/no-image-320.png" alt="NO IMAGE" title="NO IMAGE" style="width:100%;height:auto;" class="no-image popular-list-no-image" /></a>
  <?php endif; ?>
